    ...
    <div className="bg-white rounded-2xl border border-gray-100 shadow-sm flex flex-col">
      ...
      <div className="px-5 pb-5 flex gap-2">
        <button
          ...
          className="flex-1 py-2 rounded-lg text-xs font-semibold text-white bg-navy-700 hover:bg-navy-600 transition-colors"
        >
          Open
        </button>
        <button
          onClick={handleDelete}
          className="flex-1 py-2 rounded-lg text-xs font-semibold text-red-500 bg-red-50 hover:bg-red-100 transition-colors"
        >
          Delete
        </button>
      </div>
